...
describe('Authentication', () => {
  it('should return a 201 status code when a regular staff is created', (done) => {
    chai
      .request(app)
  ...
  it('should respond with 400 status code if bad username or password', (done) => {
    chai
      .request(app)
  ...
  it('should return a 401 error for an Invalid password', (done) => {
    chai
      .request(app)
      .post('/api/v1/auth/signin')
      .set('Accept', 'application/x-www-form-urlencoded')
